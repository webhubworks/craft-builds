    ...
    <Base>
        ...
        <div class="space-y-4">
            ...
            <t-card>
                ...
                <div class="space-y-4 grid grid-cols-2 max-w-lg">
                    <div class="space-y-1">
                    ...
                    <div class="space-y-1">
                        <div class="flex items-center space-x-1">
                            ...
                            <Tooltip text="These fees are due annually to ensure that you continue to receive updates. (one year after release at the earliest)"></Tooltip>
                        </div>
