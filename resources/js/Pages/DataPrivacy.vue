    ...
    <div class="min-h-screen">
        ...
        <div class="container min-h-[60vh] ">
            ...
            <section class="max-w-prose	mx-auto">
                <h1>Data privacy / Datenschutz</h1>
                <h2>Name und Kontakt des
                    Verantwortlichen gemäß Artikel 4 Abs. 7 DSGVO</h2>
                <p>Johannes Ahrndt - <a href="mailto:ahrndt@webhub.de">ahrndt@webhub.de<br></a>Marten Brosch - <a
                    href="mailto:brosch@webhub.de">brosch@webhub.de</a></p>
                <p><strong>webhub GmbH</strong><br>Hasselbruch 28<br>18059 Rostock</p>
                ...
                <p>„Personenbezogene Daten“ sind alle Informationen, die sich auf eine identifizierte oder
                    ...
                    einer Online-Kennung oder zu einem oder mehreren besonderen Merkmalen identifiziert werden kann,
                    die Ausdruck der physischen, physiologischen, genetischen, psychischen, wirtschaftlichen,
                    kulturellen oder sozialen Identität dieser natürlichen Person sind.</p>
                <h3>2. Verarbeitung</h3>
                <p>„Verarbeitung“ ist jeder, mit oder ohne Hilfe automatisierter Verfahren, ausgeführter Vorgang
                ...
                <p>„Pseudonymisierung“ ist die Verarbeitung personenbezogener Daten in einer Weise, dass die
                ...
                <h3>6. Dateisystem</h3>
                <p>„Dateisystem“ ist jede strukturierte Sammlung personenbezogener Daten, die nach bestimmten
                ...
                <h3><strong>7. Verantwortlicher</strong></h3>
                <p>„Verantwortlicher“ ist eine natürliche oder juristische Person, Behörde, Einrichtung oder andere
                ...
                <p>Eine „Einwilligung“ der betroffenen Person ist jede freiwillig für den bestimmten Fall, in
                    ...
                    einverstanden ist.<br></p>
                <h2>Rechtmäßigkeit der Verarbeitung</h2>
                <p>Die <a href="https://webhub.de/falscher-link">Verarbeitung</a> personenbezogener Daten ist nur
                    rechtmäßig, wenn für die Verarbeitung eine Rechtsgrundlage besteht. Rechtsgrundlage für die
                    Verarbeitung können gemäß Artikel 6 Abs. 1 lit. a – f DSGVO insbesondere sein:</p>
                <ol>
                    ...
                    <li>die Verarbeitung ist zur Wahrung der berechtigten Interessen des Verantwortlichen oder eines
                        ...
                        insbesondere dann, wenn es sich bei der betroffenen Person um ein Kind handelt.<br></li>
                </ol>
                ...
                <ol>
                    ...
                    <li>Sie können Ihre Browser-Einstellung entsprechend Ihren Wünschen konfigurieren und<br>z. B.
                        die Annahme von Third-Party-Cookies oder allen Cookies ablehnen. Sog. „Third Party Cookies“
                        sind Cookies, die durch einen Dritten gesetzt wurden, folglich nicht durch die eigentliche
                        Website auf der man sich gerade befindet. Wir weisen Sie darauf hin, dass Sie durch die
                        Deaktivierung von Cookies eventuell nicht alle Funktionen dieser Website nutzen können.<br>
                    </li>
                </ol>
                <p>Wir setzen Cookies ein, um Sie für Folgebesuche identifizieren zu können, falls Sie über einen
                ...
                <p>(1) Neben der rein informatorischen Nutzung unserer Website bieten wir verschiedene Leistungen
                ...
                <p>(2) Teilweise bedienen wir uns zur Verarbeitung Ihrer Daten externer Dienstleister. Diese wurden
                    von uns sorgfältig ausgewählt und beauftragt, sind an unsere Weisungen gebunden und werden
                    regelmäßig kontrolliert.</p>
                <p>(3) Weiterhin können wir Ihre personenbezogenen Daten an Dritte weitergeben, wenn
                    ...
                    personenbezogenen Daten oder untenstehend in der Beschreibung des Angebotes.</p>
                ...
                <ol>
                    ...
                    <li>ddie betroffene Person Widerspruch gegen die Verarbeitung gemäß Artikel 21 Absatz 1 DSGVO
                ...
                <p>Werden personenbezogene Daten verarbeitet, um Direktwerbung zu betreiben, so haben SIe das Recht,
                    ...
                    verarbeitet.</p>
                <p>Im Zusammenhang mit der Nutzung von Diensten der Informationsgesellschaft könne Sie ungeachtet
                ...
                <p>Sie haben unbeschadet eines verfügbaren verwaltungsrechtlichen oder außergerichtlichen
                    Rechtsbehelfs einschließlich des Rechts auf Beschwerde bei einer Aufsichtsbehörde gemäß <a
                        href="https://dsgvo-gesetz.de/art-77-dsgvo/">Artikel 77</a> DSGVO das Recht auf einen
                    wirksamen gerichtlichen Rechtsbehelf, wenn sie der Ansicht ist, dass die ihr aufgrund dieser
                    Verordnung zustehenden Rechte infolge einer nicht im Einklang mit dieser Verordnung stehenden
                    Verarbeitung ihrer personenbezogenen Daten verletzt wurden.<br></p>
                ...
                <p>(5) Wir nutzen Google Analytics, um die Nutzung unserer Website analysieren und regelmäßig
                    ...
                    Daten in die USA übertragen werden, hat sich Google dem EU-US Privacy Shield unterworfen,<a
                        ...
                        https://www.privacyshield.gov/EU-US-Framework</a>. Rechtsgrundlage für die Nutzung von
                    Google Analytics ist Art. <a
                        href="https://beck-online.beck.de/?typ=reference&amp;y=100&amp;a=6&amp;g=EWG_DSGVO">6</a>
                    Abs. <a
                        href="https://beck-online.beck.de/?typ=reference&amp;y=100&amp;a=6&amp;g=EWG_DSGVO&amp;x=1">1</a>
                    S. 1 lit. f DSGVO.</p>
                <p>(6) Informationen des Drittanbieters: Google Dublin, Google Ireland Ltd., Gordon House, Barrow
                    Street, Dublin 4, Ireland, Fax: +353 (1) 436 1001. Nutzerbedingungen:</p>
                <p><a href="http://www.google.com/analytics/terms/de.html" target="_blank"
                      rel="noreferrer noopener">http://www.google.com/analytics/terms/de.html</a>, Übersicht zum
                    Datenschutz:<a href="http://www.google.com/intl/de/analytics/learn/privacy.html">
                        http://www.google.com/intl/de/analytics/learn/privacy.html</a>, sowie die
                    Datenschutzerklärung: <a href="http://www.google.de/intl/de/policies/privacy" target="_blank"
                                             rel="noreferrer noopener">http://www.google.de/intl/de/policies/privacy</a>.
                </p>
                <p>(7) Diese Website verwendet Google Analytics zudem für eine geräteübergreifende Analyse von
                    ...
                    deaktivieren.<br></p>
                <h2>Du hast wirklich bis hier gescrollt? Warum? 🤔 Schreib uns doch eine Nachricht, sicherlich
                    können wir dir helfen.</h2></section>
...
export default {
    components: {LandingRectangles, BaseFooter, LandingHeader},
    methods: {
        createNew() {
