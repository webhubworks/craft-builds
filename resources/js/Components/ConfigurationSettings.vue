    ...
    <div>
      ...
      isShown
            ...
            <div class="py-1 rounded-md shadow-xs" slot-scope="{ hide, blurHandler }">
                <button class="block w-full px-4 py-2 leading-5 text-gray-700 transition duration-150 ease-in-out hover:bg-gray-100 focus:outline-none focus:bg-gray-100 text-left border-b" @click.prevent="shareModalOpen = true">Share</button>
                <button class="block w-full px-4 py-2 leading-5 text-gray-700 transition duration-150 ease-in-out hover:bg-gray-100 focus:outline-none focus:bg-gray-100 text-left" @click.prevent="currencyModalOpen = true">Change currency</button>
                <button class="block w-full px-4 py-2 leading-5 text-gray-700 transition duration-150 ease-in-out hover:bg-gray-100 focus:outline-none focus:bg-gray-100 text-left" @click.prevent="localeModalOpen = true">Change locale</button>
            </div>
        </t-dropdown>
